...
import CharacterStopCarousel from "./CharacterStopCarousel";
...
If you're curious about that experience, [you can check out my race report here!](https://arrayoflight.gatsbyjs.io/race-reports/wdw-half-marathon-2020).
...
![The castle all lit up](../wdw-half-marathon-2020/castle.png)
...
These don't come out as good (see example below), so if you want really nice pictures, get the PhotoPass, especially if you expect to stop for lots of characters. 
...
![A blurry photo of me and Stitch](../wdw-half-marathon-2020/stitch.png)
...
<iframe
    src="https://open.spotify.com/embed/playlist/1rogdZEqf2m0xUMvAkbOIK"
...
![My vision board I made for the marathon](./visionboard.jpg)
